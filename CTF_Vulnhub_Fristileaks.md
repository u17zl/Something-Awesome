...
### Port Scanning:
Running Nmap  
`nmap -p- -sS -sV -vv 192.168.0.110` over the VM revealed that the only common port that was open, was port 80, which it identified as running Apache on CentOS:  
